...
SECRET_KEY = os.getenv('SECRET_KEY', default='django-insecure-df6ic^_n55hqqr2low)@_*ve%618i%o(rfdi&imd%5ym$-*5bb')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', default='balance'),
        'USER': os.getenv('POSTGRES_USER', default='balance_user'),
